...
mkdirp(dir,function(err)
	{
		 ...
		 {
			fs.writeFile(dir+"/"+datos.dbNombre+".js", "\'use strict\';\n const express = require(\'express\');\n const "+ datos.tabla +"= require(\'../controllers/"+datos.tabla+"\');\n const api = express.Router();\n module.exports=function(app){ app.get(\'/"+datos.campo1+"\',jwtauth, requireAuth,"+datos.tabla+".get"+datos.tabla+"s);\n app.post(\'/"+datos.campo1+"\',jwtauth, requireAuth,"+datos.tabla+".insert"+datos.tabla+");\n}", function(err) {
			    if(err)
			    {
